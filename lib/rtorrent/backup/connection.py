...
from xmlrpc.clients.http import HTTPServerProxy
from xmlrpc.clients.scgi import SCGIServerProxy
from xmlrpc.transports.basic_auth import BasicAuthTransport

# Try import requests transport (optional)
try:
    from xmlrpc.transports.requests_ import RequestsTransport
except ImportError:
